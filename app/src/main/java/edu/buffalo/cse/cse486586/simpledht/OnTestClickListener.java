...
public class OnTestClickListener implements OnClickListener {
	...
	private ContentValues[] initTestValues() {
        ...
        cv[48].put(KEY_FIELD, "tp6FKBxE6lc3cGVFH61xOEqAtG81PE51");
        cv[48].put(VALUE_FIELD, "10");

        cv[49].put(KEY_FIELD, "qdj3i1VUwwtXUPrHKLHnRlI5tn0x32Bx");
        cv[49].put(VALUE_FIELD, "12");
